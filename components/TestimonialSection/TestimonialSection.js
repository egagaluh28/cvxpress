...
export default function TestimonialSection() {
  ...
  return (
      <div id="TestimonialSection" className="py-5">
                      ...
                      <div className="testimonial-content">
                        ...
                        <div className="testimonial-body">
                          ...
                          <p>
                            ...
                            polished resume removes one of the pain points for
                            job seekers.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="testimonial-content">
                        ...
                        <div className="testimonial-body">
                          ...
                          <p>
                            ...
                            optimized for ATS screeners. With just a simple
                            click, you can seamlessly incorporate pre-written
                            descriptions.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="testimonial-card">
                      <div className="testimonial-content">
                        ...
                        <div className="testimonial-body">
                          ...
                          <p>
                            The worker's market has created fierce competition
                            for roles. Your resume is the first impression and
                            an essential opportunity to distinguish yourself.
                            The CVXpress Resume builder is a great tool to help
                            you stand out.
                          </p>
                        </div>
                      </div>
